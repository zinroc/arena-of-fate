...
$heroku_postgre_url = parse_url ("postgres://mkdznpczpjujqw:-eXeolCCi7EyTXW-eeRPJt5ozh@ec2-54-83-46-91.compute-1.amazonaws.com:5432/d7d3kbhheh5023");
...
if ($_SERVER['REMOTE_ADDR'] === '127.0.0.1' /*$_SERVER['SERVER_NAME'] === "localhost"*/) {
	...
	$db['default']['password'] = "";
	$db['default']['database'] = "d5v948pipeoha7";
