    ...
    var fighterStore = {
        ...
        save: function (fighter, email) {
            ...
            .then(function () {
                ...
                return fighterStore.saveFighterPersonality(fighter);
            }).then(function () {
                return fighter.id;
            });
        },
        ...
        */
        ...
        /**
        *   Fills out the character_personalities table for a fighter
        */
        saveFighterPersonality: function (fighter){
            var promises = [];
            var personalities = ['playful', 'earthly', 'ambitious', 'spiritual'];

            for (var i=0; i<2; i++){
                var personality = personalities[Math.floor(Math.random()*personalities.length)];
                promises[i] = knex("character_personalities").insert({
                    character: fighter.id,
                    index: i,
